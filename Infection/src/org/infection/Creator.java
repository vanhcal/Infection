...
public class Creator {
	...
	/**
	 * This class creates all of our courses, all of our users, and pairs each
	 * student or teacher with each of their courses. As mentioned in User
	 * class, we aren't very concerned with the difference between students and
	 * teachers here. If we were, we could add separate ArrayLists, setters, and
	 * getters for each type.
	 * 
	 * When adding users and courses to our roster, we check to see if the new
	 * addition is a duplicate of something already existing and throw an
	 * exception if it is.
	 * 
	 * I also have a 'getRandomUser' method which helps us to test our
	 * infection methods.
	 */
	...
	public void newUserCoursePairings() {
		...
		addUserToCourse(userRoster.get(22), courseRoster.get(7));
		addUserToCourse(userRoster.get(23), courseRoster.get(7));
	}
